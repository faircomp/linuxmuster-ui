...
const ExtendedOptionKeys = {
  ...
  COLLABORA_WOPI_SECRET: 'COLLABORA_WOPI_SECRET',
  ACTIVE_DOCUMENT_EDITOR: 'ACTIVE_DOCUMENT_EDITOR',
  CALENDAR_CALDAV_BASE_URL: 'CALENDAR_CALDAV_BASE_URL',
  CALENDAR_CALDAV_AUTH_MODE: 'CALENDAR_CALDAV_AUTH_MODE',
  CALENDAR_CALDAV_REJECT_UNAUTHORIZED: 'CALENDAR_CALDAV_REJECT_UNAUTHORIZED',
} as const;
